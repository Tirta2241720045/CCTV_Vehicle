    ...
    def database_insert(self, license_plate, class_name, image_path, current_time):
        ...
        try:
            ...
            if vehicle_result:
                ...
                employee_query = "SELECT id FROM Employee WHERE id_vehicle = %s"
                ...
                if employee_result:
                    ...
                    intership_query = "SELECT id FROM Intership WHERE id_vehicle = %s"
                    ...
                    if intership_result:
                        ...
                        guest_query = "SELECT id FROM Guest WHERE id_vehicle = %s"
